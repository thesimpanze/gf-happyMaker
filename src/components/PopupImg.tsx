    ...
    >
      <div className=" bg-white w-1/3 h-fit rounded-lg p-3 pt-4 flex flex-col gap-2">
        ...
        <span>
          ...
          di kabulin semua, kamu selalu sehat selalu dan bahagia terus yaa.
          selalu inget juga sama orang-orang baik yang ada di sekitarmu, dan
          jangan lupa berbagi sedikit rezeki buat orang yang membutuhkan
          sayangg, enjoyy the show bb.
        </span>
